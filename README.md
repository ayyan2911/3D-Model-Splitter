...
COLMAP (modello originale)

split_colmap_interactive.py

Parti COLMAP + cluster_bounds.json

Addestramento Gaussian Splatting su ogni parte

clean_gaussian.py (usa cluster_bounds.json)

PLY puliti per ogni parte

merge_ply_files.py

Modello Gaussian Splatting completo e pulito
